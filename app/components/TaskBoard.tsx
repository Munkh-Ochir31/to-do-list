...
export function TaskBoard({ user }: { user: UserDTO }) {
  const tweaks = TWEAKS;
  // Тактик [Authorize]: client тал зөвхөн UI-г нуух/харуулахад role ашиглана.
  // Бодит шалгалт нь сервер тал дээр (DAL) хийгдэнэ.
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "32px 16px 64px", minHeight: "100vh" }}>
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: 13, color: "#0a0a0a", fontWeight: 500 }}>{user.name}</span>
            <span
              style={{
                fontSize: 10,
                fontWeight: 600,
                padding: "2px 7px",
                borderRadius: 999,
                background: isAdmin ? "#0a0a0a" : "#e5e5e5",
                color: isAdmin ? "#fff" : "#525252",
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          >
            ...
            <div style={{ display: "flex", gap: 8, flexShrink: 0 }}>
              {/* Тактик [Authorize]: Статусын тохиргоог зөвхөн админ хийнэ. */}
              {isAdmin && (
                <button
